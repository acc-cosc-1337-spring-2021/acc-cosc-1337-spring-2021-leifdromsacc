...
bool TicTacToe4::check_row_win()
{
    ...
    if ((pegs[0] == "O" && pegs[1] == "O" && pegs[2] == "O" && pegs[3] == "O") || (pegs[4] == "O" && pegs[5] == "O" && pegs[6] == "O" && pegs[7] == "O") || (pegs[8] == "O" && pegs[9] == "O" && pegs[10] == "O" && pegs[11] == "O") || (pegs[12] == "O" && pegs[13] == "O" && pegs[14] == "O" && pegs[15] == "O"))
    {
        return true;
    }
...
bool TicTacToe4::check_column_win()
{
    ...
    if ((pegs[0] == "O" && pegs[4] == "O" && pegs[8] == "O" && pegs[12] == "O") || (pegs[1] == "O" && pegs[5] == "O" && pegs[9] == "O" && pegs[13] == "O") || (pegs[2] == "O" && pegs[6] == "O" && pegs[10] == "O" && pegs[14] == "O") || (pegs[3] == "O" && pegs[7] == "O" && pegs[11] == "O" && pegs[15] == "O"))
    {
        return true;
    }
